...
import { useCategoryQuery, useCreateProductMutation, useSubCategoryQuery } from "../../../generated/graphql";
import LoadingPage from "../../../components/LoadingPage/LoadingPage";

const CreateProduct = ({ setShow, refetch }: any) => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (res.data?.CreateProduct.success) {
            Notifications(res.data.CreateProduct.message, "success");
            setShow(false);
        }
        refetch();
        Notifications(res.data?.CreateProduct.message, "error");
    }
    ...
    if (loading || category_loading) return <LoadingPage />;
