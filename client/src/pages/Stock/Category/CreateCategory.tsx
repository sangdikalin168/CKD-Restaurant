...
export const CreateCategory = ({ setShow, refetch }: any) => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (res.data?.CreateCategory.success) {
            Notifications(res.data?.CreateCategory.message, "success");
            setShow(false);
            refetch();
        }

        Notifications(res.data?.CreateCategory.message, "error");
        setShow(false);
    }
